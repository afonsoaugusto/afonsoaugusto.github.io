...
Índice desta página: [https://afonsorodrigues.com/pages/](https://afonsorodrigues.com/pages/). Lista complementar com todos os repositórios públicos do usuário **afonsoaugusto** nos quais o GitHub Pages está habilitado (consulta à API `GET /repos/{owner}/{repo}/pages`, 12 de maio de 2026).

- [afonsoaugusto](https://afonsorodrigues.com/afonsoaugusto/) — `afonsoaugusto/afonsoaugusto`
- [Site principal (blog)](https://afonsorodrigues.com/) — `afonsoaugusto/afonsoaugusto.github.io`
- [CKS](https://afonsorodrigues.com/cks/) — `afonsoaugusto/cks`
- [Data Challenge Stone](https://afonsorodrigues.com/data-challenge-stone/) — `afonsoaugusto/data-challenge-stone`
- [Dynamic Servers Nginx](https://afonsorodrigues.com/dynamic-servers-nginx/) — `afonsoaugusto/dynamic-servers-nginx`
- [Karpenter — melhores práticas](https://afonsorodrigues.com/karpenter-best-pratices/) — `afonsoaugusto/karpenter-best-pratices`
- [Metronome Trainer](https://afonsorodrigues.com/metronome-trainer/) — `afonsoaugusto/metronome-trainer`
- [Questões sobre Nginx](https://afonsorodrigues.com/nginx-questions/) — `afonsoaugusto/nginx-questions`
- [Percona 3Day](https://afonsorodrigues.com/percona-3day/) — `afonsoaugusto/percona-3day`
